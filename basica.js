...
let puntuacion = 0;
const duracionJuego = 15; // 2 minutos en segundos
...
// Funcionalidad de los dardos
document.addEventListener('keydown', (event) => {
    if (event.key === ' ') { // Usa la barra espaciadora para lanzar dardos
        lanzarDardo();
    }
});

function lanzarDardo() {
    // Aquí puedes añadir animación para el dardo
    // Por simplicidad, solo se muestra un mensaje
    console.log('Dardo lanzado!');
}
